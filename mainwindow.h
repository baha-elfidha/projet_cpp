...
//*****************************************************************amine
      ...
      void on_supprimer_bag_clicked();

      void on_Modifier_bag_clicked();

      void on_pushButton_2_bag_clicked();

      void on_Annuler_bag_clicked();
     void on_Chercher_bag_clicked();
  ...
  void on_pushButton_10_bag_clicked();

  void on_pushButton_8_bag_clicked();
  ...
  void on_pushButton_11_bag_clicked();
